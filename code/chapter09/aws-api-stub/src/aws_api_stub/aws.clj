...
(def db-instances {"RDS123" {"DBInstanceIdentifier" "RDS123", "DBInstanceStatus" "available"}
                   "RDS456" {"DBInstanceIdentifier" "RDS456", "DBInstanceStatus" "available"}})

(defn describe-db-instances [instance-id]
  {"DBInstances"
   [(get db-instances instance-id)]})
